package com.lingdian.dangjian.view.yrecycleview;
...
public class YRecycleview extends RecyclerView {
    ...
    public void onScrolled(int dx, int dy) {
        ...
        if (scrolling != null)
            scrolling.OnYRecycleScrolled(moveY);
//        if (dy > 0) {
//            System.out.println("*********UP**********" + moveY);
//        } else {
//            System.out.println("*********DOWN**********" + moveY);
//        }
    }

    private OnYRecycleScrolling scrolling;

    public interface OnYRecycleScrolling {
        void OnYRecycleScrolled(int moveY);
    }

    public void setOnYRecycleScrolling(OnYRecycleScrolling scrolling) {
