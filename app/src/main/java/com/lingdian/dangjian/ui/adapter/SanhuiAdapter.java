 ...
 */
public class SanhuiAdapter extends RecyclerView.Adapter<SanhuiAdapter.ViewHolder> {



    private Context context;
    private List<Sanhui.DataListBean> list = new ArrayList<>();

    public SanhuiAdapter(Context context) {
        this.context = context;
    }


    public void onReference(List<Sanhui.DataListBean> list1) {
        if (list1 != null) {
            list.clear();
            list.addAll(list1);
    ...
    public void addOnReference(List<Sanhui.DataListBean> list1) {
        if (list1 != null) {
            list.addAll(list1);
            notifyDataSetChanged();
        }
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        Sanhui.DataListBean dataBean = list.get(position);
